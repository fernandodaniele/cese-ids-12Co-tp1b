...
/**
 * @brief Estructura para documentar la información de un alumno
 * 
 */
 ...
 * @param   espacio   Cantidad de bytes disponibles en la cadena de resultados
 * @param   alumno    Puntero a la estructura con los datos el alumno
